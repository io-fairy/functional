...
/**
 * Represents a <b>predicate</b> (boolean-valued function) of 6 arguments.<br>
 ...
 */
@FunctionalInterface
public interface P6<T1, T2, T3, T4, T5, T6> extends LambdaRN<Boolean>, Lambda6<T1, T2, T3, T4, T5, T6> {
    boolean $(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6);
}

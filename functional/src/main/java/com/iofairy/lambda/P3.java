...
/**
 * Represents a <b>predicate</b> (boolean-valued function) of 3 arguments.<br>
 ...
 */
@FunctionalInterface
public interface P3<T1, T2, T3> extends LambdaRN<Boolean>, Lambda3<T1, T2, T3> {
    boolean $(T1 t1, T2 t2, T3 t3);
}

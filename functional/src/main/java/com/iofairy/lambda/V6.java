...
/**
 * Represents a function that accepts 6 arguments and returns no result<br>
 ...
 */
@FunctionalInterface
public interface V6<T1, T2, T3, T4, T5, T6> extends LambdaVN, Lambda6<T1, T2, T3, T4, T5, T6> {
    void $(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6);
}

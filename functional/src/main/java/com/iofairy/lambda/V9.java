...
/**
 * Represents a function that accepts 9 arguments and returns no result<br>
 ...
 */
@FunctionalInterface
public interface V9<T1, T2, T3, T4, T5, T6, T7, T8, T9> extends LambdaVN, Lambda9<T1, T2, T3, T4, T5, T6, T7, T8, T9> {

...
/**
 * Represents a <b>predicate</b> (boolean-valued function) of 8 arguments, and will throw exception<br>
 * 表示一个接收 8个参数 并返回boolean值且抛出异常的函数
 *
 ...
 */
@FunctionalInterface
public interface PT8<T1, T2, T3, T4, T5, T6, T7, T8, E extends Throwable> extends LambdaRT<Boolean, E>, Lambda8<T1, T2, T3, T4, T5, T6, T7, T8> {
    boolean $(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8) throws E;
}

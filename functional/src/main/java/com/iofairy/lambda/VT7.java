...
/**
 * Represents a function that accepts 7 arguments and returns no result, and will throw exception<br>
 ...
 */
@FunctionalInterface
public interface VT7<T1, T2, T3, T4, T5, T6, T7, E extends Throwable> extends LambdaVT<E>, Lambda7<T1, T2, T3, T4, T5, T6, T7> {
    void $(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7) throws E;
}

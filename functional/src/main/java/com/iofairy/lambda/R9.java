...
/**
 * Represents a function that accepts 9 arguments and produces a result<br>
 ...
 */
@FunctionalInterface
public interface R9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> extends LambdaRN<R>, Lambda9<T1, T2, T3, T4, T5, T6, T7, T8, T9> {

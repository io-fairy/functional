...
/**
 * Represents a function that accepts 5 arguments and returns no result<br>
 ...
 */
@FunctionalInterface
public interface V5<T1, T2, T3, T4, T5> extends LambdaVN, Lambda5<T1, T2, T3, T4, T5> {
    void $(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5);
}

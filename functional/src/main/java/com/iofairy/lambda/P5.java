...
/**
 * Represents a <b>predicate</b> (boolean-valued function) of 5 arguments.<br>
 ...
 */
@FunctionalInterface
public interface P5<T1, T2, T3, T4, T5> extends LambdaRN<Boolean>, Lambda5<T1, T2, T3, T4, T5> {
    boolean $(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5);
}

...
/**
 * Represents a function that accepts 1 argument and produces a result, and will throw exception<br>
 ...
 */
@FunctionalInterface
public interface RT1<T, R, E extends Throwable> extends LambdaRT<R, E>, Lambda1<T> {
    R $(T t) throws E;
}

...
/**
 * Represents a function that accepts 8 arguments and returns no result<br>
 ...
 */
@FunctionalInterface
public interface V8<T1, T2, T3, T4, T5, T6, T7, T8> extends LambdaVN, Lambda8<T1, T2, T3, T4, T5, T6, T7, T8> {

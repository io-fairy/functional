...
public class Null8Matcher<T1, T2, T3, T4, T5, T6, T7, R> implements Matcher {
    ...
    public <V, NV, E extends Throwable> Null9Matcher<T1, T2, T3, T4, T5, T6, T7, NV, R> withV(V matchValue, RT1<? super V, ? extends NV, E> computeValue, RT1<? super NV, Boolean, E> action, RT1<Tuple7<T1, T2, T3, T4, T5, T6, T7>, ? extends R, E> msgAction) throws E {
        Objects.requireNonNull(computeValue);
        Objects.requireNonNull(msgAction);
        if (!isMatch) {
            R msg = msgAction.$(Tuple.of(value1, value2, value3, value4, value5, value6, value7));
    ...
    public <V, NV, E extends Throwable> Null9Matcher<T1, T2, T3, T4, T5, T6, T7, NV, R> withV(V matchValue, RT1<? super V, ? extends NV, E> computeValue, RT1<Tuple7<T1, T2, T3, T4, T5, T6, T7>, ? extends R, E> msgAction) throws E {
        return withV(matchValue, computeValue, null, msgAction);
    }

    public <V, NV, E extends Throwable> Null9Matcher<T1, T2, T3, T4, T5, T6, T7, NV, R> withV(V matchValue, RT1<? super V, ? extends NV, E> computeValue, RT1<? super NV, Boolean, E> action, R msg) throws E {
        Objects.requireNonNull(computeValue);
        if (!isMatch) {
            if (matchValue == null) {
                return new Null9Matcher<>(true, value1, value2, value3, value4, value5, value6, value7, null, msg);
    ...
    public <V, NV, E extends Throwable> Null9Matcher<T1, T2, T3, T4, T5, T6, T7, NV, R> withV(V matchValue, RT1<? super V, ? extends NV, E> computeValue, R msg) throws E {
        return withV(matchValue, computeValue, null, msg);
    }

    public <NV, E extends Throwable> Null9Matcher<T1, T2, T3, T4, T5, T6, T7, NV, R> withW(PatternNull1 patternNull, RT1<? super T1, ? extends NV, E> computeValue, RT1<? super NV, Boolean, E> action, RT1<Tuple7<T1, T2, T3, T4, T5, T6, T7>, ? extends R, E> msgAction) throws E {
        Objects.requireNonNull(computeValue);
        Objects.requireNonNull(patternNull);
        Objects.requireNonNull(msgAction);
        if (!isMatch) {
    ...
    public <NV, E extends Throwable> Null9Matcher<T1, T2, T3, T4, T5, T6, T7, NV, R> withW(PatternNull1 patternNull, RT1<? super T1, ? extends NV, E> computeValue, RT1<Tuple7<T1, T2, T3, T4, T5, T6, T7>, ? extends R, E> msgAction) throws E {
        return withW(patternNull, computeValue, null, msgAction);
    }

    public <NV, E extends Throwable> Null9Matcher<T1, T2, T3, T4, T5, T6, T7, NV, R> withW(PatternNull1 patternNull, RT1<? super T1, ? extends NV, E> computeValue, RT1<? super NV, Boolean, E> action, R msg) throws E {
        Objects.requireNonNull(computeValue);
        Objects.requireNonNull(patternNull);
        if (!isMatch) {
            NV newValue = computeValue.$(value1);
    ...
    public <NV, E extends Throwable> Null9Matcher<T1, T2, T3, T4, T5, T6, T7, NV, R> withW(PatternNull1 patternNull, RT1<? super T1, ? extends NV, E> computeValue, R msg) throws E {
        return withW(patternNull, computeValue, null, msg);
    }

    public <NV, E extends Throwable> Null9Matcher<T1, T2, T3, T4, T5, T6, T7, NV, R> withW(PatternNull2 patternNull, RT1<? super T2, ? extends NV, E> computeValue, RT1<? super NV, Boolean, E> action, RT1<Tuple7<T1, T2, T3, T4, T5, T6, T7>, ? extends R, E> msgAction) throws E {
        Objects.requireNonNull(computeValue);
        Objects.requireNonNull(patternNull);
        Objects.requireNonNull(msgAction);
        if (!isMatch) {
    ...
    public <NV, E extends Throwable> Null9Matcher<T1, T2, T3, T4, T5, T6, T7, NV, R> withW(PatternNull2 patternNull, RT1<? super T2, ? extends NV, E> computeValue, RT1<Tuple7<T1, T2, T3, T4, T5, T6, T7>, ? extends R, E> msgAction) throws E {
        return withW(patternNull, computeValue, null, msgAction);
    }

    public <NV, E extends Throwable> Null9Matcher<T1, T2, T3, T4, T5, T6, T7, NV, R> withW(PatternNull2 patternNull, RT1<? super T2, ? extends NV, E> computeValue, RT1<? super NV, Boolean, E> action, R msg) throws E {
        Objects.requireNonNull(computeValue);
        Objects.requireNonNull(patternNull);
        if (!isMatch) {
            NV newValue = computeValue.$(value2);
    ...
    public <NV, E extends Throwable> Null9Matcher<T1, T2, T3, T4, T5, T6, T7, NV, R> withW(PatternNull2 patternNull, RT1<? super T2, ? extends NV, E> computeValue, R msg) throws E {
        return withW(patternNull, computeValue, null, msg);
    }

    public <NV, E extends Throwable> Null9Matcher<T1, T2, T3, T4, T5, T6, T7, NV, R> withW(PatternNull3 patternNull, RT1<? super T3, ? extends NV, E> computeValue, RT1<? super NV, Boolean, E> action, RT1<Tuple7<T1, T2, T3, T4, T5, T6, T7>, ? extends R, E> msgAction) throws E {
        Objects.requireNonNull(computeValue);
        Objects.requireNonNull(patternNull);
        Objects.requireNonNull(msgAction);
        if (!isMatch) {
    ...
    public <NV, E extends Throwable> Null9Matcher<T1, T2, T3, T4, T5, T6, T7, NV, R> withW(PatternNull3 patternNull, RT1<? super T3, ? extends NV, E> computeValue, RT1<Tuple7<T1, T2, T3, T4, T5, T6, T7>, ? extends R, E> msgAction) throws E {
        return withW(patternNull, computeValue, null, msgAction);
    }

    public <NV, E extends Throwable> Null9Matcher<T1, T2, T3, T4, T5, T6, T7, NV, R> withW(PatternNull3 patternNull, RT1<? super T3, ? extends NV, E> computeValue, RT1<? super NV, Boolean, E> action, R msg) throws E {
        Objects.requireNonNull(computeValue);
        Objects.requireNonNull(patternNull);
        if (!isMatch) {
            NV newValue = computeValue.$(value3);
    ...
    public <NV, E extends Throwable> Null9Matcher<T1, T2, T3, T4, T5, T6, T7, NV, R> withW(PatternNull3 patternNull, RT1<? super T3, ? extends NV, E> computeValue, R msg) throws E {
        return withW(patternNull, computeValue, null, msg);
    }

    public <NV, E extends Throwable> Null9Matcher<T1, T2, T3, T4, T5, T6, T7, NV, R> withW(PatternNull4 patternNull, RT1<? super T4, ? extends NV, E> computeValue, RT1<? super NV, Boolean, E> action, RT1<Tuple7<T1, T2, T3, T4, T5, T6, T7>, ? extends R, E> msgAction) throws E {
        Objects.requireNonNull(computeValue);
        Objects.requireNonNull(patternNull);
        Objects.requireNonNull(msgAction);
        if (!isMatch) {
    ...
    public <NV, E extends Throwable> Null9Matcher<T1, T2, T3, T4, T5, T6, T7, NV, R> withW(PatternNull4 patternNull, RT1<? super T4, ? extends NV, E> computeValue, RT1<Tuple7<T1, T2, T3, T4, T5, T6, T7>, ? extends R, E> msgAction) throws E {
        return withW(patternNull, computeValue, null, msgAction);
    }

    public <NV, E extends Throwable> Null9Matcher<T1, T2, T3, T4, T5, T6, T7, NV, R> withW(PatternNull4 patternNull, RT1<? super T4, ? extends NV, E> computeValue, RT1<? super NV, Boolean, E> action, R msg) throws E {
        Objects.requireNonNull(computeValue);
        Objects.requireNonNull(patternNull);
        if (!isMatch) {
            NV newValue = computeValue.$(value4);
    ...
    public <NV, E extends Throwable> Null9Matcher<T1, T2, T3, T4, T5, T6, T7, NV, R> withW(PatternNull4 patternNull, RT1<? super T4, ? extends NV, E> computeValue, R msg) throws E {
        return withW(patternNull, computeValue, null, msg);
    }

    public <NV, E extends Throwable> Null9Matcher<T1, T2, T3, T4, T5, T6, T7, NV, R> withW(PatternNull5 patternNull, RT1<? super T5, ? extends NV, E> computeValue, RT1<? super NV, Boolean, E> action, RT1<Tuple7<T1, T2, T3, T4, T5, T6, T7>, ? extends R, E> msgAction) throws E {
        Objects.requireNonNull(computeValue);
        Objects.requireNonNull(patternNull);
        Objects.requireNonNull(msgAction);
        if (!isMatch) {
    ...
    public <NV, E extends Throwable> Null9Matcher<T1, T2, T3, T4, T5, T6, T7, NV, R> withW(PatternNull5 patternNull, RT1<? super T5, ? extends NV, E> computeValue, RT1<Tuple7<T1, T2, T3, T4, T5, T6, T7>, ? extends R, E> msgAction) throws E {
        return withW(patternNull, computeValue, null, msgAction);
    }

    public <NV, E extends Throwable> Null9Matcher<T1, T2, T3, T4, T5, T6, T7, NV, R> withW(PatternNull5 patternNull, RT1<? super T5, ? extends NV, E> computeValue, RT1<? super NV, Boolean, E> action, R msg) throws E {
        Objects.requireNonNull(computeValue);
        Objects.requireNonNull(patternNull);
        if (!isMatch) {
            NV newValue = computeValue.$(value5);
    ...
    public <NV, E extends Throwable> Null9Matcher<T1, T2, T3, T4, T5, T6, T7, NV, R> withW(PatternNull5 patternNull, RT1<? super T5, ? extends NV, E> computeValue, R msg) throws E {
        return withW(patternNull, computeValue, null, msg);
    }

    public <NV, E extends Throwable> Null9Matcher<T1, T2, T3, T4, T5, T6, T7, NV, R> withW(PatternNull6 patternNull, RT1<? super T6, ? extends NV, E> computeValue, RT1<? super NV, Boolean, E> action, RT1<Tuple7<T1, T2, T3, T4, T5, T6, T7>, ? extends R, E> msgAction) throws E {
        Objects.requireNonNull(computeValue);
        Objects.requireNonNull(patternNull);
        Objects.requireNonNull(msgAction);
        if (!isMatch) {
    ...
    public <NV, E extends Throwable> Null9Matcher<T1, T2, T3, T4, T5, T6, T7, NV, R> withW(PatternNull6 patternNull, RT1<? super T6, ? extends NV, E> computeValue, RT1<Tuple7<T1, T2, T3, T4, T5, T6, T7>, ? extends R, E> msgAction) throws E {
        return withW(patternNull, computeValue, null, msgAction);
    }

    public <NV, E extends Throwable> Null9Matcher<T1, T2, T3, T4, T5, T6, T7, NV, R> withW(PatternNull6 patternNull, RT1<? super T6, ? extends NV, E> computeValue, RT1<? super NV, Boolean, E> action, R msg) throws E {
        Objects.requireNonNull(computeValue);
        Objects.requireNonNull(patternNull);
        if (!isMatch) {
            NV newValue = computeValue.$(value6);
    ...
    public <NV, E extends Throwable> Null9Matcher<T1, T2, T3, T4, T5, T6, T7, NV, R> withW(PatternNull6 patternNull, RT1<? super T6, ? extends NV, E> computeValue, R msg) throws E {
        return withW(patternNull, computeValue, null, msg);
    }

    public <NV, E extends Throwable> Null9Matcher<T1, T2, T3, T4, T5, T6, T7, NV, R> withW(PatternNull7 patternNull, RT1<? super T7, ? extends NV, E> computeValue, RT1<? super NV, Boolean, E> action, RT1<Tuple7<T1, T2, T3, T4, T5, T6, T7>, ? extends R, E> msgAction) throws E {
        Objects.requireNonNull(computeValue);
        Objects.requireNonNull(patternNull);
        Objects.requireNonNull(msgAction);
        if (!isMatch) {
    ...
    public <NV, E extends Throwable> Null9Matcher<T1, T2, T3, T4, T5, T6, T7, NV, R> withW(PatternNull7 patternNull, RT1<? super T7, ? extends NV, E> computeValue, RT1<Tuple7<T1, T2, T3, T4, T5, T6, T7>, ? extends R, E> msgAction) throws E {
        return withW(patternNull, computeValue, null, msgAction);
    }

    public <NV, E extends Throwable> Null9Matcher<T1, T2, T3, T4, T5, T6, T7, NV, R> withW(PatternNull7 patternNull, RT1<? super T7, ? extends NV, E> computeValue, RT1<? super NV, Boolean, E> action, R msg) throws E {
        Objects.requireNonNull(computeValue);
        Objects.requireNonNull(patternNull);
        if (!isMatch) {
            NV newValue = computeValue.$(value7);
    ...
    public <NV, E extends Throwable> Null9Matcher<T1, T2, T3, T4, T5, T6, T7, NV, R> withW(PatternNull7 patternNull, RT1<? super T7, ? extends NV, E> computeValue, R msg) throws E {
        return withW(patternNull, computeValue, null, msg);
    }
